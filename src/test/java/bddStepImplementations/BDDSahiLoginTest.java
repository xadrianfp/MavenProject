package bddStepImplementations;
...
public class BDDSahiLoginTest {
	  ...
	  public String browser = "Firefox"; //"IE" ó Chrome ó Firefox
	...
	public void user_set_passwd (String passwd) {
		...
		System.out.println("El usuario ingresa la contraseña:"+passwd);
	}
	...
	public void user_access_ShoppinPage () throws InterruptedException {
		System.out.println("El usuario se encuentra en la pagina de login");
		System.out.println("Estamos en la página:" + driver.getTitle());
		Thread.sleep(1000);
	...
	public void user_gets_confirmation (String status) throws InterruptedException {
		...
		System.out.println("Estamos en la página:" + driver.getTitle() + ". Y el resultado fue: "+status);
		Thread.sleep(1000);
